...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */}var it;null===(it=window.HTMLSlotElement)||void 0===it||it.prototype.assignedElements;var st=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let nt=class extends Q{constructor(){super(...arguments),this.disabled=!1,this.autofocus=!1,this.canSelect=!1,this.disableSelectedStyle=!1,this.href="",this.btnStyle="",this.selected=!1,this.buttonElement=null}static get styles(){return[o`
        :host {
...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
const rt=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}{constructor(t){var e;if(super(t),t.type!==ot||"style"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,i)=>{const s=t[i];return null==s?e:e+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ct){this.ct=new Set;for(const t in e)this.ct.add(t);return this.render(e)}this.ct.forEach((t=>{null==e[t]&&(this.ct.delete(t),t.includes("-")?i.removeProperty(t):i[t]="")}));for(const t in e){const s=e[t];null!=s&&(this.ct.add(t),t.includes("-")?i.setProperty(t,s):i[t]=s)}return H}});var lt=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};const at="overlay",ht="overlay-background",dt="open";let ct=class extends Q{constructor(){super(...arguments),this.open=!1}static get styles(){return o`
      :host {
        display: block;
      }
    ...
    `}firstUpdated(){document.addEventListener("keyup",this.handleKeyUp.bind(this))}render(){const{open:t}=this;return R`
      <div
        style=${rt({display:t?"flex":"none"})}
        class=${ht}
        part=${ht}>
        <div class=${at} part=${at}>
          <slot></slot>
        </div>
      </div>
    `}updated(t){t.has(dt)&&!!t.get(dt)!==this.open&&setTimeout((()=>this.onOpenChanged()),0)}onOpenChanged(){this.dispatchEvent(new CustomEvent("openChanged",{detail:this.open}))}handleKeyUp(t){this.open&&("Escape"===t.key||"Esc"===t.key?this.dispatchEvent(new CustomEvent("escKeyDown")):"Enter"===t.key&&this.dispatchEvent(new CustomEvent("enterKeyDown")))}};lt([et({type:Boolean,reflect:!0})],ct.prototype,"open",void 0),ct=lt([Y("qing-overlay")],ct);const ut=o`
  button {
    background-color: #e7e7e7;
    color: black;
    border: 0;
...
${`${"2020 is coming. ".repeat(20)}\n`.repeat(500)}</pre
    ...
    `}rElement(t,e,i){return R`
      ...
      ${i}
    `}get mainElement(){return this.shadowRoot.getElementById("main")}handleLightBtnClick(){this.mainElement.classList.remove("theme-dark")}handleDarkBtnClick(){this.mainElement.classList.add("theme-dark")}}vt.styles=[ut,o`
  ...
  `],customElements.define("example-app",vt),t.ExampleApp=vt,Object.defineProperty(t,"__esModule",{value:!0})}({});
